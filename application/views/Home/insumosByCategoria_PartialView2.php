<div class="box">
    ...
    <div class="box-body table-responsive">
        <section id="no-more-tables">
            <table id="<?php echo $idTabla; ?>" class="table table-striped  table-condensed cf" style="margin:0 auto 0;">					
           ...
           <?php
               ...
               ?>		
                   <tr>
                       ...
                       <td data-title='STOK' class="col-sd-1" style='text-align:center;'><?php echo $fila['in_cantidad']; ?></td>
...
<script type="text/javascript">
    $(function(){
       // console.log("Este es el Id => <?php echo $idTabla; ?>");
