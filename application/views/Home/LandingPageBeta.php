			...
			<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="<?php echo base_url();?>img/kuanto 1.jpg" alt="Image">
						<div class="carousel-caption">
							 <h3>Jack Daniels Huge Pack</h3>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo base_url();?>img/kuanto 2.jpg" alt="Image Alternative text" title="iPhone 5 iPad mini iPad 3" />
						<div class="carousel-caption countdown-caption">
							<h3>Apple Big Deal</h3>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo base_url();?>img/kuanto 3.jpg" alt="Image Alternative text" title="the best mode of transport here in maldives" />
						<div class="carousel-caption countdown-caption">
							<h3>Finshing in Maldives</h3>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo base_url();?>img/kuanto 4.jpg" alt="Image Alternative text" title="the best mode of transport here in maldives" />
						<div class="carousel-caption countdown-caption">
							<h3>Finshing in Maldives</h3>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo base_url();?>img/kuanto 5.jpg" alt="Image Alternative text" title="the best mode of transport here in maldives" />
						<div class="carousel-caption countdown-caption">
							<h3>Finshing in Maldives</h3>
						</div>
					</div>
					<div class="item">
						<img src="<?php echo base_url();?>img/kuanto 6.jpg" alt="Image Alternative text" title="the best mode of transport here in maldives" />
						<div class="carousel-caption countdown-caption">
							<h3>Finshing in Maldives</h3>
						</div>
					</div>
			...
			<div class="col-md-12" >
				<div class="row">
					...
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_materiales.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								...
								<a href="<?php echo base_url();?>registro">Compruébalo entrando ahora…</a>
							</div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_servicios.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								<b>SERVICIOS</b><br>
								...
								<a href="<?php echo base_url();?>registro">Publica ahora , es gratis…</a>
							</div>
						</div>
					</div>
					<div class="col-md-1"></div>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_herrammientas.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								<b>HERRAMIENTAS</b><br>
								Descubre las mas novedosas herramientas de  marcas
								reconocidas del mercado, a los mejores precios.
								<a href="<?php echo base_url();?>registro">Regístrate en un paso…</a>
							</div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_indirectos.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								...
								<a href="<?php echo base_url();?>registro">Rápido y Fácilmente…</a>
							</div>
						</div>
					</div>
					<div class="col-md-1"></div>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_equipos.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								<b>EQUIPO</b><br>
								Obtén acceso a los proveedores de equipos para la construcción de tu 
								localidad y proveedores de todo el mundo.
								<a href="<?php echo base_url();?>registro">Creando una cuenta…</a>
							</div>
						</div>
					</div>
					<div class="col-md-5">
						<div class="row">
							<div class="col-md-4">
								<img src="<?php echo base_url();?>img/kuanto_maquinaria.png" alt="imagen" width="184px" height="184px">
							</div>
							<div class="col-md-8 parrafo">
								<b>MAQUINARIA</b><br>
								Encuentra la maquinaria que buscas en las mejores condiciones para tu proyecto.
								<a href="<?php echo base_url();?>registro">En línea en todo momento…</a>
							</div>
						</div>
					</div>
					<div class="col-md-1"></div>
