            ...
            <aside class="right-side">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="materiales_Tab">
                                <div class="box">
                                    ...
                                    <div class="box-body table-responsive">
                                        <div class="row">
                                            <div class="col-md-9" style="text-align:center; cursor:pointer;">
                                                   
                                            </div>
                                            <div class="col-md-3" style="text-align:right; cursor:pointer;">
                                                <a class="btn btn-primary" data-role='button' href="<?php echo base_url();?>articulos/articulos_balnco_h" title="No encuentras lo que buscas, Solicita un insumo">
                                        ...
                                        <section id="no-more-tables">
                                            <table id="tablaInsumosGlobal" class="table table-striped table-condensed cf" style="margin:0 auto 0;">
                                                ...
                                                while ($fila = mysql_fetch_array($rs_articulos)){
                                                        ...
                                                        if($fila['emp_tienda'] == 0){

                                                            $imagenTienda = "<img src='".base_url()."Images/users/".$fila['emp_imagen']."' alt='AVATAR' width='30' height='30' />"; 
                                                        }else{
                                                            $imagenTienda = "<a href='".base_url()."home/tienda/".$fila['emp_id']."'><img src='".base_url()."Images/users/".$fila['emp_imagen']."' alt='AVATAR' width='30' height='30' /></a>";    
                                                        }
                                                ...
                                                ?>		
                                                    <tr>
                                                        ...
                                                        <td data-title='STOK' style='text-align:center;' class="col-sd-1"><?php echo $fila['in_cantidad']; ?></td>
                                                        ...
                                                        <td style='text-align:center;' class="col-sm-1">
                                                            <a  role="button" class='btn btn-primary btn-sm LaunchModalDetails' href="<?php echo base_url();?>home/detalles/<?php echo $fila['in_id']; ?>/H" >
                            ...
                            <div class="tab-pane" id="herramientas_Tab">
                                <?php 
                                    ...
                                    $this->load->view('Home/insumosByCategoria_PartialView2', $arrayHerramientas);
                                ?>
                            </div>
                            ...
                            <div class="tab-pane" id="equipos_Tab">
                                <?php 
                                    ...
                                    $this->load->view('Home/insumosByCategoria_PartialView2', $Arrayequipos);
                                ?>
                            </div>
                            ...
                            <div class="tab-pane" id="maquinaria_Tab">
                                <?php 
                                    ...
                                    $this->load->view('Home/insumosByCategoria_PartialView2', $arrayMaquinaria);
                                ?>
                            </div>
                            ...
                            <div class="tab-pane" id="servicios_Tab">
                                <?php 
                                    ...
                                    $this->load->view('Home/insumosByCategoria_PartialView2', $arrayservicios);
                                ?>
                            </div>
                            ...
                            <div class="tab-pane" id="indirectos_Tab">
                                <?php 
                                    ...
                                    $this->load->view('Home/insumosByCategoria_PartialView2', $arrayindirectos);
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5" style="text-align:center; cursor:pointer;">
                        <a href="<?php echo base_url();?>articulos/articulos_balnco_h">
                            <i class='fa fa-plus'></i> 
	...
	<script type="text/javascript">
		...
		$(function(){
                $('#tablaInsumosGlobal').dataTable({
                        ...
                        "aoColumns": [{ "bSortable": false }, null, null, null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false }] ,
