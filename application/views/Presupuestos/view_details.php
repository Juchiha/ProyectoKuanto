...
<html>
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div style="text-align: left;" class="content-header">
						 <a href="<?php echo base_url();?>presupuestos/mis_presupuestos" data-rel="button" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Volver</a>
                    </div>
                    <div>&nbsp;</div>
                    <table class="table table-striped table-bordered table-hover" style="margin:0 auto 0;">
                        ...
                        ?>		
                            <tr>
								<td class="col-sd-1 presupuesto" style="text-align:left;" tro="presupuesto_<?php echo $fila['acum_id']; ?>" value="<?php echo $fila['acum_id']; ?>" tdo="td_<?php echo $fila['acum_id']; ?>" mat="matris_<?php echo $fila['acum_id']; ?>" idtd="matrix_<?php echo $fila['acum_id']; ?>">
									<i class="fa fa-caret-square-o-right"></i>
								</td>
                                <td class="col-sd-1" ><?php echo $fila['acum_sigla']; ?></td>
                                <td class="col-sd-5" ><?php echo $fila['acum_nombre']; ?></td>
                            ...
                            <tr class="ocultar" id="presupuesto_<?php echo $fila['acum_id']; ?>" style="color: #119AA7;">
								<td colspan="7" id="td_<?php echo $fila['acum_id']; ?>"></td>
                            </tr>
                            <tr class="ocultar" id="matris_<?php echo $fila['acum_id']; ?>" style="color: #0000FF;">
								<td colspan="7" id="matrix_<?php echo $fila['acum_id']; ?>"></td>
                            </tr>
                        <?php	
                            }
                        ?>
	...
	<script type="text/javascript">	
            ...
            presupuestos = {
                getagrupadores:function(tro, idag){
					$.ajax({
						type : "POST",
						url  : "<?PHP echo base_url(); ?>presupuestos/getagrupador/"+idag,
				...
				getMatrixes:function(tro, idag){
					$.ajax({
						type : "POST",
						url  : "<?PHP echo base_url(); ?>presupuestos/getMatrix/"+idag,
						success: function(data){
							tro.html(data);
						} 
					});
            ...
            $(function(){
				...
				$(".presupuesto").click(function(){
					var tro  = $("#" + $(this).attr("tro") ) ;
					var idag = $(this).attr('value');
					var tdo  = $(this).attr('tdo');
					var mat  = $("#" + $(this).attr("mat") );
					
					presupuestos.getagrupadores(tro, idag);
					presupuestos.getMatrixes(mat, idag);
