                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-mailbox">
                                <tr class="unread">
                                    ...
                                    <td class="name"><a href="#">Jose David</a></td>
                                    <td class="subject"><a href="#">Urgente leelo rapido</a></td>
                                    <td class="time">12:30 PM</td>
                                </tr>
                                <tr>
                                    <td class="small-col"><input type="checkbox" /></td>
                                    <td class="small-col"><i class="fa fa-star-o"></i></td>
                                    <td class="name"><a href="#">Efren Esparza</a></td>
                                    <td class="subject"><a href="#">Jose! Apurate</a></td>
                                    <td class="time">12:30 PM</td>
                                </tr>
                                <tr>
                                    <td class="small-col"><input type="checkbox" /></td>
                                    <td class="small-col"><i class="fa fa-star-o"></i></td>
                                    <td class="name"><a href="#">Richard  Fonseca</a></td>
                                    <td class="subject"><a href="#">Jose!!!! ayudame no se que hacer</a></td>
                                    <td class="time">12:30 PM</td>
                                </tr>
                                <tr class="unread">
                                    <td class="small-col"><input type="checkbox" /></td>
                                    <td class="small-col"><i class="fa fa-star-o"></i></td>
                                    <td class="name"><a href="#">Jose Giron</a></td>
                                    <td class="subject"><a href="#">Mensaje de pruebas</a></td>
                                    <td class="time">12:30 PM</td>
                                </tr>
                                <tr>
                                    <td class="small-col"><input type="checkbox" /></td>
