                        ...
                        <div class='row'>
                            <div class='col-md-6'>
                                <div style='text-align: left;' class='content-header'>
                                    <a href='<?php echo base_url(); ?>opciones/getcity/<?php echo $ciudad; ?>' class='btn btn-primary bg-light-blue' title='Volver'><i class='fa fa-arrow-circle-left'></i>Volver</a>
                                </div>
                            </div>
                            <div class='col-md-6'>
                                <?php if($rows == 0) { ?>
                                <div style='text-align: right;' class='content-header'>
                                    <a  data-target='#compose-modal' data-toggle='modal'  class='btn btn-primary bg-light-blue' title='editar' role='button'>
						...
						<div class="box-body table-responsive">
							<table id="UsersTable" class="table table-striped" style="margin:0 auto 0;">
								<thead class="widget-header">
									<tr>
										<th style="text-align:center;" class="col-md-4" >NOMBRES</th>
										...
										<th style="text-align:center;" class="col-sd-1" >OPCIONES</th>
								</tr>
								</thead>
								<tbody>
								<?php
								while ($fila = mysql_fetch_array($admin)) {?>
									<tr>
										<td class="col-md-4"><?php echo $fila['admin']; ?></th>
										...
										<td class="col-md-2" ><?php echo $fila['emp_correo'];?></td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i class="fa fa-envelope-o"></i> Nuevo administrador</h4>
                                </div>
                                <?php echo form_open_multipart("opciones/createAdmins"); ?>
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="apellidos" placeholder="Apellidos" name="apellidos" class="form-control" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="phone" id="telefono" name="telefono" class="form-control" placeholder="Telefono">
                                        </div>
		...
		<script type="text/javascript">
           ...
           /*    $("#envioMensaje").click(function(){
            ...
            <?php if(isset($adminError)){?>
                alertify.error('<?php echo $adminError; ?>');
            <?php } ?>
			});
		</script>
