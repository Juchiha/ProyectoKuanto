        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url(); ?>Home/homePage"><i class="fa fa-dashboard"></i> Local</a></li>
                ...
                <section class="content">
                    ...
                    <div style="text-align: left;" class="content-header">
                        <a href="<?php echo base_url(); ?>Home/homePage" class="btn btn-primary bg-light-blue" title="Volver"><i class="fa fa-arrow-circle-left"></i>Volver</a>
                    </div>
                    <div>&nbsp;</div>
                    <form action="<?php echo base_url();?>articulos/insertarArticuloBlanco" method="POST">
                        <input type="hidden" name="procedencia" value="h"> 
                        <div class="row">
                            <div class="col-md-1">&nbsp;</div>
                            <div class="col-md-4" style="text-align: center;">
                                <img id="imagen" alt="Image Insumo" width="300" height="300"/>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="precio" disabled class="form-control" id="precio" placeholder="Precio">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" id="stok" disabled name="stok" class="form-control" placeholder="Stok">
                                        </div>    
                                    </div>
                                </div>
                                <div class="row">
