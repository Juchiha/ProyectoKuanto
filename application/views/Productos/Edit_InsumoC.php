        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    ?> 
                    <?=form_open_multipart('articulos/editarinsumoC'); ?>
                        
                        <input  type="hidden" id="id" name="id" value="<?php echo $fila['in_id']; ?>">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="descripcion" name="descripcion" class="form-control" required><?php echo $fila['in_descripcion']; ?></textarea>
                                        </div> 
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input  type="text" id="stok" name="stok" class="form-control" value="<?php echo $fila['in_cantidad']; ?>" required placeholder="Stok">
                                        </div>    
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6" style="text-align: right;">
                                        <button type="submit" class="btn btn-primary">Editar Insumo Compuesto</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">&nbsp;</div>
                    ...
                    <script>
                        $(function(){
                           $("#unidad").val(<?php echo $fila['in_unidad']; ?>);
                        });
                    </script>
                   <?php  } ?>
