        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Insumos
                        <small>Mis Insumos</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Insumos</a></li>
                        <li class="active">Mis Insumos</li>
                    </ol>
                ...
                <section class="content">
                    ...
                    <div style="text-align: left;" class="content-header">
						<?php 
							if($count == 0){
								 echo '<a href="'.base_url().'articulos/create" class="btn btn-primary bg-light-blue" title="agrega tus articulos"><i class="fa fa-plus-circle"></i> agrega tus articulos</a>';
							}else{
								echo '<a href="'.base_url().'articulos/create" class="btn btn-primary bg-light-blue" title="Agregar Insumo"><i class="fa fa-plus-circle"></i> Agregar Insumo</a>';
							}
						?> 
                    </div>
                    <div>&nbsp;</div>
                    <section id="no-more-tables">
                        <table id="tablamisInsumos" class="table table-striped table-bordered table-hover table-condensed cf" style="margin:0 auto 0;">
                            ...
                            <tbody>
                            <?php
                                while ($fila = mysql_fetch_array($misInsumos)){
                                        $urlenvio = null;
                                        if($fila['in_url'] != null){
                            ...
                            ?>		
                                <tr>
                                    ...
                                    <td data-title='PRECIO' style='text-align:right; font-size: 11px;' >$ <?php echo $fila['in_precio']; ?></td>
                                    ...
                                    <td style='text-align:center;' class="col-sd-3"  >
    										<?php if($fila['in_publicado'] == 1){ ?>
                                            <a class='btn btn-danger btn-sm' title="Despublicar" href="<?php echo base_url();?>articulos/despublicar/<?php echo $fila['in_id'];?>">
                                                    <i class='fa fa-thumbs-o-down'></i>
                                            </a>
                                            <?php }else{ ?>
                                            <a class='btn btn-primary btn-sm' title="Publicar" href="<?php echo base_url();?>articulos/publicar/<?php echo $fila['in_id'];?>">
                    ...
                    <div style="text-align: left;" class="content-header">
                        <?php 
                            if($cantidadConpuestos == 0){
                                 echo '<a href="'.base_url().'articulos/createInsumoC" class="btn btn-primary bg-light-blue" title="agrega tus insumos compuesto"><i class="fa fa-plus-circle"></i> agrega tus insumos compuestos</a>';
                            }else{
                                echo '<a href="'.base_url().'articulos/createInsumoC" class="btn btn-primary bg-light-blue" title="Agregar Insumo compuesto"><i class="fa fa-plus-circle"></i> Agregar Insumo Compuesto</a>';
                            }
                        ?> 
                    </div>
                    <section id="no-more-tables">
                        <table id="tablamisInsumoscompuestos" class="table table-striped table-bordered table-hover table-condensed cf" style="margin:0 auto 0;">
                            ...
                            <tbody>
                            <?php
                                while ($fila = mysql_fetch_array($compuesto)){
                            ...
                            ?>      
                                <tr>
                                    ...
                                    <td data-title='UNIDAD' style='text-align:center;'  ><?php echo $fila['sigla']; ?></td>
                                    <td data-title='STOK' style='text-align:left;'  ><?php echo $fila['in_cantidad']; ?></td>
                                    <td data-title='PRECIO' style='text-align:right; font-size: 11px;' ></td>
                                    <td data-title='FECHA' style='width:70px;' class="col-md-1" ><?php echo $fila['in_fecha_']; ?></td>
                                    <td data-title='CIUDAD' class="col-sd-1" ><?php echo $fila['ti_nombre']; ?></td>
                                    <td data-title='LOG' class="col-sd-1" ><div <?php echo $popover; ?> style="text-align:center;"><img src='<?php echo base_url(); ?>Images/users/<?php echo $fila['emp_imagen']; ?>' alt='AVATAR' width='30' height='30' /></div></td>
                                    <td data-title='IMG' class="col-sd-1" style="text-align:center;"></td>
                                    <td style='text-align:center;' class="col-sd-3"  >
                                            
                                            <a title="Eliminar" class='btn btn-danger btn-sm btneliminar' href="<?php echo base_url();?>articulos/eliminar/<?php echo $fila['in_id'];?>">
                                                    <i class='fa fa-trash-o'></i>
                                            </a>
                                            <a href="<?php echo base_url();?>articulos/editarinsumo/<?php echo $fila['in_id'];?>" role="button" title="Editar" class='btn btn-success btn-sm'>
                                                    <i class='fa fa-edit '></i>
                                            </a>
                                            <a href = "<?php echo base_url();?>articulos/agregarInsumos/<?php echo $fila['in_id']; ?>" role="button" class='btn btn-warning btn-sm'>
                                                    <i class='fa fa-cog'></i>
                                            </a>
                                    </td>
                                </tr>
	...
	<script type="text/javascript">	
            ...
            $(function(){
                $('#tablamisInsumos').dataTable({
                    ...
                    "aoColumns": [{ "bSortable": false },{ "bSortable": false },  null,null ,{ "bSortable": false }, { "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false },	 { "bSortable": false }] ,
                ...
                $("#tablamisInsumoscompuestos").dataTable({
                    "oLanguage": {
                        "sLengthMenu": "_MENU_ registros por pagina",
                        "sZeroRecords": "0 resultados en el criterio de busqueda",
                        "sInfo": "Mostrando de _START_ a _END_ de _TOTAL_ registros",
                    ...
                    "aoColumns": [null, null,{ "bSortable": false }, { "bSortable": false },null,{ "bSortable": false },{ "bSortable": false },{ "bSortable": false },     { "bSortable": false }] ,
                    "fnDrawCallback": function (oSettings, json) {
                            $(".imagenAvatar").popover({trigger: 'hover','placement': 'left', html:true});
                            $(".LaunchModalDetails").click(function(){
                                productos.LaunchModalDetails($(this).attr('idInsumo'));
