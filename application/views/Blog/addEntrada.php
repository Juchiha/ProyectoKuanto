        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div> &nbsp;</div>
                    <?=form_open_multipart('blog/createPost'); ?>
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input type="text" name="titulo" class="form-control" required placeholder="Titulo del Post">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                   <textarea name="Descripcion" class="form-control" required placeholder="De que se trata el Post, esto es lo que aparecera en la pagina principal del post, puedes copiar una parte de este o crear una entrada original"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input id="exampleInputFile" name="filaInput" type="file" required>
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <textarea id="editor1" required name="editor1" rows="10" class="form-control"></textarea>  
                                </div>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
