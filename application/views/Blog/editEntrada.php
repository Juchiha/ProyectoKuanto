        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div style="text-align: left;" class="content-header">
                                <a href="<?php echo base_url(); ?>blog/verentradas" class="btn btn-primary bg-light-blue" title="Volver"><i class="fa fa-arrow-circle-left"></i>Volver</a>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div> &nbsp;</div>
                    <?php echo form_open_multipart('blog/editPost'); ?>
                    <?php while($fila = mysql_fetch_array($datos)) { ?>
                        <input type="hidden" name="id" value="<?php echo $fila['pos_id'];?>">
                        <input type="hidden" id="inputImagen" name="imagen" value="NO">
                        <div class="row">
                            <div class="col-md-1"></div>
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input type="text" name="titulo" class="form-control" required placeholder="Titulo del Post" value="<?php echo $fila['pos_titulo']; ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                   <textarea name="Descripcion" class="form-control" required placeholder="De que se trata el Post, esto es lo que aparecera en la pagina principal del post, puedes copiar una parte de este o crear una entrada original"><?php echo $fila['pos_descripcion']; ?></textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <input id="exampleInputFile" name="filaInput" type="file" >

                                    <p class="help-block">
                                        Esta es la imagen que aparecera, en todas las paginas del post
                                    </p>
                                </div>
                            </div>
                            <div class="col-md-1"></div>
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <textarea id="editor1" name="editor1" rows="10" class="form-control"><?php echo $fila['pos_contenido']; ?></textarea>  
                                </div>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
                        <div class='row'>
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <button id="butonenvio" name="Envios" class="btn btn-primary">Guardar</button>  
                                </div>
                            </div>
                            <div class="col-md-1"></div>
                        </div>
