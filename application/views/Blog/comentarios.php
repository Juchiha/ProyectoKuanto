                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="UsersTable" class="table table-striped" style="margin:0 auto 0;">
                                ...
                                <tbody>
                                <?php while ($fila = mysql_fetch_array($post)){
                                    $imagenUsuario ="<img src='". base_url()."Images/users/".$fila['emp_imagen']."' alt='PERFIL/AVATAR' width='161' height='161'/>";
                                    $popover = 'class="imagenAvatar" title="'.$fila['usuario'].'" data-content="'.$imagenUsuario.'"';
                                    $imagenTienda = "<img src='".base_url()."Images/users/".$fila['emp_imagen']."' alt='AVATAR' width='30' height='30' />"; 
                                ?>
                                
                                    <tr>
                                        <td class="col-md-1"><div style="text-align:center;" <?php echo $popover; ?>><?php echo $imagenTienda; ?></div></td>
                                        <td class="col-md-3"><?php echo $fila['usuario']; ?></td>
                                        <td class="col-md-2"><?php echo $fila['com_fecha']; ?></td>
                                        <td class="col-md-5"><?php echo $fila['com_descripcion']; ?></td>
                                        <td class="col-sm-3"  style="text-align: center;">
                                            <a href='<?php echo base_url();?>blog/eliminarComentario/<?php echo $fila['com_id'];?>/<?php echo $id;?>' class='btn btn-danger btn-sm btnMatriz' title="Eliminar" role="button">
